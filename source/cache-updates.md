...
You can make `__typename` automatic by adding addTypename property as true to the Apollo Client constructor. So to do `dataIdFromObject` most concisely, your client initialization might look like this:
